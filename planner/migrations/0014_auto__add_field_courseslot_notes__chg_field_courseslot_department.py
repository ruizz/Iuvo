...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CourseSlot.notes'
        db.add_column(u'planner_courseslot', 'notes',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


        # Changing field 'CourseSlot.department'
        db.alter_column(u'planner_courseslot', 'department', self.gf('django.db.models.fields.CharField')(max_length=4))

    def backwards(self, orm):
        # Deleting field 'CourseSlot.notes'
        db.delete_column(u'planner_courseslot', 'notes')


        # Changing field 'CourseSlot.department'
        db.alter_column(u'planner_courseslot', 'department', self.gf('django.db.models.fields.CharField')(max_length=50))
