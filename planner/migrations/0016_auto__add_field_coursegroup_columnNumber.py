...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CourseGroup.columnNumber'
        db.add_column(u'planner_coursegroup', 'columnNumber',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CourseGroup.columnNumber'
        db.delete_column(u'planner_coursegroup', 'columnNumber')


    models = {
        u'planner.coursegroup': {
            'Meta': {'unique_together': "(('name', 'degreePlan'),)", 'object_name': 'CourseGroup'},
            'columnNumber': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
