...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'planner_useraccount', 'degreePlan',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['planner.DegreePlan'], unique=True, null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'planner.useraccount': {
            ...
            'degreePlan': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['planner.DegreePlan']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
