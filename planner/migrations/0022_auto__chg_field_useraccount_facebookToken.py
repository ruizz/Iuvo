...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserAccount.facebookToken'
        db.alter_column(u'planner_useraccount', 'facebookToken', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'UserAccount.facebookToken'
        db.alter_column(u'planner_useraccount', 'facebookToken', self.gf('django.db.models.fields.CharField')(max_length=50))
