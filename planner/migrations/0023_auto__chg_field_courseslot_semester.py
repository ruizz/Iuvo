...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CourseSlot.semester'
        db.alter_column(u'planner_courseslot', 'semester_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['planner.Semester'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'CourseSlot.semester'
        db.alter_column(u'planner_courseslot', 'semester_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['planner.Semester'], null=True))
    ...
    models = {
        ...
        u'planner.useraccount': {
            ...
            'facebookToken': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200', 'blank': 'True'}),
