...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CourseSlot.isCompleted'
        db.add_column(u'planner_courseslot', 'isCompleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CourseSlot.isCompleted'
        db.delete_column(u'planner_courseslot', 'isCompleted')
